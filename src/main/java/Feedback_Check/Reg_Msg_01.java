...
public class Reg_Msg_01 {
    ...
    public static void Register_TC03() throws InterruptedException {
        ...
        email.sendKeys("testassign4@test.com");
        ...
        //String expectedMessage2 = "Warning: E-Mail Address is already registered!";
        WebElement errorMessage1 = driverObj.findElement(By.xpath("//*[@id=\"content\"]/h1"));
        //WebElement errorMessage2 = driverObj.findElement(By.xpath("//*[@id=\"account-register\"]/div[1]"));
        String actualMessage1 = errorMessage1.getText();
        //String actualMessage2 = errorMessage2.getText();}
